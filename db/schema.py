...
# (per Wayne's 综合打分系统 v2.0 spec — accumulate event-level scoring
#  inputs/outputs from day one so Phase 3 statistical calibration has data
#  to work with later.)
